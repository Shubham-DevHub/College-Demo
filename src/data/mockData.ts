...
export const INITIAL_TICKETS: SupportTicket[] = [
  {
    ...
    description: 'Unable to connect to Apex-Secure student network on Ubuntu laptop.',
    status: 'In Progress',
    priority: 'Medium',
